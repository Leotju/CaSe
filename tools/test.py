...
import shutil
import tempfile
from eval_scripts.coco import COCO
from eval_scripts.eval_MR_multisetup import COCOeval
import mmcv
import torch
...
def parse_args():
    ...
    parser.add_argument('--out', help='output result file', default='eval_scripts/case.pkl')
    parser.add_argument(
        '--eval',
        type=str,
        nargs='+',
