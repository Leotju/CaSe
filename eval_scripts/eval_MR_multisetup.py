...
class COCOeval:
    ...
    def evaluateImg(self, imgId, catId, hRng, vRng, maxDet):
        ...
        dt = [d for d in dt if
              d['height'] >= hRng[0] / self.params.expFilter and d['height'] < hRng[1] * self.params.expFilter]
    ...
    def summarize(self, id_setup, res_file):
        ...
        def _summarize(iouThr=None, maxDets=100):
            p = self.params
            iStr = ' {:<18} {} @ {:<18} [ IoU={:<9} | height={:>6s} | visibility={:>6s} ] = {:0.1f}%'
...
class Params:
    ...
    def setDetParams(self):
        ...
        self.HtRng = [[50, 1e5 ** 2], [50, 1e5 ** 2]]
        self.VisRng = [[0.65, 1e5 ** 2], [0.2, 0.65]]
        self.SetupLbl = ['Reasonable', 'Reasonable_occ=heavy']
